...
@NonNull
@Override
public DealsAdapter.Deal onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext())
        .inflate(R.layout.item_recycler_deals, parent, false);

        return new DealsAdapter.Deal(view);

        }

@Override
public void onBindViewHolder(@NonNull DealsAdapter.Deal holder, int position) {
