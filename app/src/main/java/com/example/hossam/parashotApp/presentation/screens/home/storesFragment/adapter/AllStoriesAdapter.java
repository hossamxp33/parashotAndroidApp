...
public class AllStoriesAdapter extends RecyclerView.Adapter<AllStoriesAdapter.CustomView> {
    ...
    public void onBindViewHolder(@NonNull CustomView holder, int position) {
        ...
        if (arrayList.get(position).isFrom_google()) {
            storesViewModel.setPhoto("https://maps.googleapis.com/maps/api/place/photo?maxwidth=" + arrayList.get(position).getMaxwidth() +
                    "&photoreference=" + arrayList.get(position).getPhoto() +
    ...
    public void setItems(ArrayList<AllStoriesModel.DataBean> newList){
        arrayList.clear();
