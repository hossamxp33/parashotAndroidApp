...
public class OffersAdapter  extends RecyclerView.Adapter<OffersAdapter.Offers> {
   ...
   OffersModel offersData;
    ...
    @NonNull
    @Override
    public OffersAdapter.Offers onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_recycler_offers, parent, false);
        return new OffersAdapter.Offers(view);

    }

    @Override
    public void onBindViewHolder(@NonNull OffersAdapter.Offers holder, int position) {
